...
def main(arguments=sys.argv[1:]):
    ...
    parser.add_argument(
        "--only_sheets", type=str, default=None, help="Not implemented yet"
    )
    ...
    parser.add_argument(
        "-f", "--format", type=str, default="dxf", help="dxf or svg output"
    )

    parser.add_argument("infile", type=str, help="STL file to process")
    ...
    to_write_dilated = {
        k: v.buffer(args.final_dilation) for k, v in to_write.items()
    }
